...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title></title>
		<link rel="stylesheet" type="text/css" href="../css/Xlog_in.css" />
	...
	<body>
		<div class="wrapper">
			...
			<div class="input login">
				...
				<div class="control">
					<input type="email" class="" name="" id="email" placeholder="电子邮箱" />
				</div>
				<div class="control">
				...
				<div class="nav_footer">
					<div class="links_footer">
						<div class="nav_links_row">
							<a class="nav_a" href="../首页.jsp">BATTLE.NET EULA </a>
							<span>|</span>
