		...
		<div class="navbars navbars_Top">
			<nav class="nav_Top" role="main">
				...
				<ul class="nav_menu nav_left">
					...
					<li>
						<a class="nav_btn" href="英雄资料1.jsp">英雄</a>
					</li>
					<li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="英雄1.jsp">英雄</li>
							<li><a href="皮肤.jsp">皮肤</li><hr>
							<li><a href="道具.jsp">道具</li>
						</ul>
					</li>
					<li>
						<a class="nav_btn" href="论坛.html">论坛</a>
					</li>
					<li>
						<a class="nav_btn" href="#" style="margin-left: 220px;">登录</a>
					</li>
					<li>
						<a class="nav_btn" href="#">注册</a>
					</li>
		...
		<footer id="footer">
			<div class="footerWrap">
				<div class="support-feedback clearFix">
					<div class="cs">
						<a class="cs-online" href="娱乐.html" target="_blank">
							<span class="icon icon-1"></span> 娱乐客服
						</a>
						<a class="cs-Feedback" href="反馈.html" target="_blank">
